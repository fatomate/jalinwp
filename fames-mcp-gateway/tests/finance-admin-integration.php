...
activate_plugin('woocommerce/woocommerce.php'); activate_plugin('fames-mcp-gateway/fames-mcp-gateway.php');
...
add_filter('fames_mcp_affiliate_details', $adapter); $adapted = FG_Finance_Admin::preview($order_id, 'gateway_Custom-01', $input);
...
ff_check(strpos(wp_json_encode($adapted), 'NEVER_ADAPTER') === false, 'Adapter result remains allowlisted.'); remove_filter('fames_mcp_affiliate_details', $adapter);
