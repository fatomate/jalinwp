...
final class FG_Connection_Trace {
    ...
    private const ROUTES = [
        '/fames-mcp/v1/mcp' => 'mcp',
        '/fames-mcp/v1/oauth/register' => 'registration',
        '/fames-mcp/v1/oauth/token' => 'token',
        '/fames-mcp/v1/oauth/revoke' => 'revocation',
        '/fames-mcp/v1/oauth/authorization-server' => 'authorization_metadata',
        '/fames-mcp/v1/oauth/protected-resource' => 'resource_metadata',
    ];
