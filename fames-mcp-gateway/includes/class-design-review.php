...
final class FG_Design_Review {
    public static function boot(): void {
        add_action('admin_enqueue_scripts', static function ($hook) {
            if ($hook !== 'settings_page_fames-mcp-gateway') { return; }
            wp_enqueue_script('fames-mcp-design-validation', plugins_url('assets/design-validation.js', FG_FILE), ['wp-blocks', 'wp-block-library'], FG_VERSION, true);
            wp_enqueue_script('fames-mcp-design-review', plugins_url('assets/design-review.js', FG_FILE), ['fames-mcp-design-validation', 'wp-dom-ready'], FG_VERSION, true);
        });
    }
