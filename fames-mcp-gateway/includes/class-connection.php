...
final class FG_Connection {
    public static function diagnostics(): array {
        ...
        $probe = wp_safe_remote_post($resource, array_replace($options, [
            ...
            'body' => wp_json_encode(['jsonrpc' => '2.0', 'id' => 'connection-check', 'method' => 'initialize', 'params' => ['protocolVersion' => FG_Server::VERSIONS[0], 'capabilities' => (object) [], 'clientInfo' => ['name' => 'fames-connection-check', 'version' => FG_VERSION]]]),
        ]));
