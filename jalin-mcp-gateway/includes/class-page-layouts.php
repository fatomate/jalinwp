...
final class FG_Page_Layouts {
	...
	public const CANVAS = 'jalin-mcp-canvas';
	private const BLOCK_NAME = 'jalin-mcp-gateway//jalin-mcp-canvas';
	...
	public static function body_class( array $classes ): array {
		if ( is_page() && self::CANVAS === get_page_template_slug( get_queried_object_id() ) ) { $classes[] = 'jalin-mcp-canvas-page'; }
		return $classes;
	}
	...
	public static function enqueue(): void {
		...
		wp_enqueue_style( 'jalin-mcp-canvas', plugins_url( 'assets/canvas.css', FG_FILE ), array( 'wp-block-library' ), FG_VERSION );
	}
