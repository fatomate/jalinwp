...
1. Upload the jalinwp-0.3.3.zip install ZIP and activate it on staging as a fresh installation.
...
Versions before this initial 0.3.3 release describe internal development only.
Historical retention/upgrade notes below are not an upgrade or compatibility
