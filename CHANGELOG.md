...
- Delete revoked/expired connections, clear inactive history, or explicitly revoke and clear all; Activity Log history is retained.
- Clear Read Only defaults for new setups while preserving saved execution modes.

## 0.3.2

- JalinWP branding with the approved Jalin Weave logo and Cobalt + Coral palette.
- Updated admin, OAuth consent, MCP display identity, and Canvas labels while retaining existing compatibility identifiers.

## 0.3.1

- Explicit Read Only, Reviewed Changes, and opt-in YOLO modes.
- Direct execution for consented YOLO connections, with existing permissions and audit controls retained.
