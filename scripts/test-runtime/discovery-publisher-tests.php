...
require_once '/wordpress/wp-content/plugins/jalin-mcp-gateway/includes/class-discovery.php';
final class FG_OAuth {
    public static string $issuer = 'https://gateway.example/wp-json/jalin-mcp/v1/oauth/issuer.json';
    public static string $resource = 'https://gateway.example/wp-json/jalin-mcp/v1/mcp';
    ...
    public static function authorization_metadata(): array {
        return array_merge(['issuer' => self::$issuer, 'authorization_endpoint' => 'https://gateway.example/wp-admin/admin-post.php?action=fg_oauth_authorize',
            'token_endpoint' => 'https://gateway.example/wp-json/jalin-mcp/v1/oauth/token', 'registration_endpoint' => 'https://gateway.example/wp-json/jalin-mcp/v1/oauth/register',
    ...
    public static function resource_metadata(): array {
        return array_merge(['resource' => self::$resource, 'authorization_servers' => [self::$issuer],
            'scopes_supported' => ['mcp'], 'bearer_methods_supported' => ['header'], 'resource_name' => 'JalinWP'], self::$resource_extra);
    }
}
$cases = [];
...
$relative = '.well-known/oauth-authorization-server/wp-json/jalin-mcp/v1/oauth/issuer.json';
$public_path = '/wordpress/' . $relative;
$resource_relative = '.well-known/oauth-protected-resource/wp-json/jalin-mcp/v1/mcp';
...
fg_publish_assert('Protected resource publication keeps the original audience and path without inventing a JSON transport URL', !str_ends_with($resource_public_path, '.json') && json_decode(file_get_contents($resource_public_path), true)['resource'] === 'https://gateway.example/wp-json/jalin-mcp/v1/mcp');
...
foreach (['http://gateway.example/wp-json/jalin-mcp/v1/oauth/issuer.json', 'https://attacker.example/wp-json/jalin-mcp/v1/oauth/issuer.json',
    'https://gateway.example:8443/wp-json/jalin-mcp/v1/oauth/issuer.json', 'https://gateway.example/wp-json/../oauth/issuer.json',
    'https://gateway.example/wp-json/%2e%2e/oauth/issuer.json', 'https://gateway.example/wp-json/jalin-mcp/v1/oauth/issuer.json?x=1',
    'https://gateway.example/wp-json/jalin-mcp/v1/oauth/issuer.json#fragment', 'https://user:secret@gateway.example/wp-json/jalin-mcp/v1/oauth/issuer.json'] as $url) {
...
foreach (['http://gateway.example/wp-json/jalin-mcp/v1/mcp', 'https://attacker.example/wp-json/jalin-mcp/v1/mcp',
    'https://gateway.example:8443/wp-json/jalin-mcp/v1/mcp', 'https://gateway.example/wp-json/../mcp',
    'https://gateway.example/wp-json/%2e%2e/mcp', 'https://gateway.example/wp-json/jalin-mcp/v1/mcp?x=1',
    'https://gateway.example/wp-json/jalin-mcp/v1/mcp#fragment', 'https://user:secret@gateway.example/wp-json/jalin-mcp/v1/mcp'] as $url) {
...
FG_OAuth::$resource = 'https://other.example/wp-json/jalin-mcp/v1/mcp';
...
$saved_issuer = FG_OAuth::$issuer; FG_OAuth::$issuer = 'https://other.example/wp-json/jalin-mcp/v1/oauth/issuer.json';
