...
```text
https://shop.example/wp-json/jalin-mcp/v1/mcp
```
...
```json
{
  "mcpServers": {
    "jalin-wordpress": {
      ...
      "args": ["/absolute/path/to/scripts/bridge/stdio.mjs"],
      "env": {
        "FG_MCP_URL": "https://shop.example/wp-json/jalin-mcp/v1/mcp",
