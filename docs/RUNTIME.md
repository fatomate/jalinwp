...
```sh
node node_modules/@php-wasm/cli/php-wasm.js -l ../../jalin-mcp-gateway/includes/class-core.php
```
...
- `/wordpress/wp-content/plugins/jalin-mcp-gateway`: live plugin source mount.
