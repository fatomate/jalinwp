...
The private repository is [fatomate/jalinwp](https://github.com/fatomate/jalinwp). JalinWP 0.3.3 is being prepared as its initial GitHub release; it is a fresh-install plugin, not an upgrade or migration release.
...
Before creating the private `v0.3.3` release, review the exact commit and the generated ZIP contents. Attach the install ZIP and, if useful, the source ZIP. GitHub-generated source archives are development archives, not WordPress install packages.
